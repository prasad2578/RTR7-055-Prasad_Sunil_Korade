...
//A       
          float x_PKshift = 0.31;
	float Y_PKshift = 0.0;

          glBegin(GL_QUADS);
	glColor3f(1.0f, 0.0f, 0.0f);
	glVertex2f(VALUE_FROM_PERSENT(-0.11f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.3f, persent)+Y_PKshift);//U1
	glVertex2f(VALUE_FROM_PERSENT(0.02f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.3f, persent)+Y_PKshift);//T1
	glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.25f, persent)+Y_PKshift);//B2
	glVertex2f(VALUE_FROM_PERSENT(-0.09f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.28f, persent)+Y_PKshift);//V1
          glEnd();
	...
	glVertex2f(VALUE_FROM_PERSENT(-0.09f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.28f, persent)+Y_PKshift);//V1
	glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.25f, persent)+Y_PKshift);//B2
	glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.0f, persent)+Y_PKshift);//N1
	glVertex2f(VALUE_FROM_PERSENT(-0.09f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.0f, persent)+Y_PKshift);//M1
          glEnd();

          
          glBegin(GL_QUADS);
	glColor3f(1.0f, 0.0f, 0.0f);
          glVertex2f(VALUE_FROM_PERSENT(-0.015f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.25f, persent)+Y_PKshift);//A2
	glVertex2f(VALUE_FROM_PERSENT(0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.28f, persent)+Y_PKshift);//S1
	glVertex2f(VALUE_FROM_PERSENT(0.02f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.3f, persent)+Y_PKshift);//T1
	glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.25f, persent)+Y_PKshift);//B2
          glEnd();
	...
	glColor3f(1.0f, 0.0f, 0.0f);
          glVertex2f(VALUE_FROM_PERSENT(-0.015f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.25f, persent)+Y_PKshift);//A2
	glVertex2f(VALUE_FROM_PERSENT(0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.28f, persent)+Y_PKshift);//S1
	glVertex2f(VALUE_FROM_PERSENT(0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.0f, persent)+Y_PKshift);//R1
	glVertex2f(VALUE_FROM_PERSENT(-0.015f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.0f, persent)+Y_PKshift);//Q1
          glEnd();

          glBegin(GL_QUADS);
	glColor3f(1.0f, 0.0f, 0.0f);
          glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.194f, persent)+Y_PKshift);//W1
	glVertex2f(VALUE_FROM_PERSENT(-0.015f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.17f, persent)+Y_PKshift);//Z1
	glVertex2f(VALUE_FROM_PERSENT(-0.015f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.112f, persent)+Y_PKshift);//P1
	glVertex2f(VALUE_FROM_PERSENT(-0.04f,persent)+x_PKshift, VALUE_FROM_PERSENT(0.14f, persent)+Y_PKshift);//O1
          glEnd();
