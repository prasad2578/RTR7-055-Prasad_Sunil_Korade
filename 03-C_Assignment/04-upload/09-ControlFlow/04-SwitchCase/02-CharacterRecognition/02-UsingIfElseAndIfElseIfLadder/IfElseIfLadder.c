...
int main(void)
{
          ...
          if ((PK_ch == 'A' || PK_ch == 'a') || (PK_ch == 'E' || PK_ch == 'e') || (PK_ch == 'I'|| PK_ch == 'i') || (PK_ch == 'O' || PK_ch == 'o') || (PK_ch == 'U' || PK_ch == 'u'))
          ...
          else 
          {
                    ...
                    if ((PK_ch_value >= CHAR_ALPHABET_UPPER_CASE_BEGINNING && PK_ch_value <= CHAR_ALPHABET_UPPER_CASE_ENDING) || (PK_ch_value>= CHAR_ALPHABET_LOWER_CASE_BEGINNING && PK_ch_value <= CHAR_ALPHABET_LOWER_CASE_ENDING))
                    {
                              printf("Charactr \'%c\' Entered By you Is A CONSONANT CHARACTER from the english alphabet !!!\n\n", PK_ch);
                    }
                    else if (PK_ch_value >= CHAR_DIGIT_BEGINNING && PK_ch_value <= CHAR_DEGIT_ENDING)
                    {
