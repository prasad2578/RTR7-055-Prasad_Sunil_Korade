...
int main(void)
{
    ...
    printf("\n\n");
    printf(" *** USING ARRAY NAME AS A ARRAY i.e : Value Of xth Element Of PK_iArray : PK_iArray[x] AND Address Of xth Element Of PK_iArray : &PK_iArray[x] *** \n\n");
    ...
    printf("\n\n");
    printf(" *** USING POINTER AS POINTER i.e : Value Of xth Element Of PK_iArray : *(PK_ptr_iArray + x) AND Address Of xth Element Of PK_iArray : (PK_ptr_iArray + x) *** \n\n");
    printf("Integer Array Elements And Their Addresses : \n\n");
