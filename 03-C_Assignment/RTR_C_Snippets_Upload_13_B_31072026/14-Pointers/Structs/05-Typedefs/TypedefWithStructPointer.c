...
int main(void)
{
    ...
    typedef struct PK_MyData* PK_MyDataPtr;
    PK_MyDataPtr PK_pData;

    printf("\n\n");

    PK_pData = (PK_MyDataPtr)malloc(sizeof(struct PK_MyData));
    if (PK_pData == NULL)
    {
    ...
    PK_pointer_to_struct_MyData_size = sizeof(PK_MyDataPtr);
